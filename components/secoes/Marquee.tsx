...
/** Faixa rolante de vestibulares e universidades mapeados. A lista é duplicada
 ...
 *  ler dezoito siglas duas vezes seguidas não informa nada. */
export function Marquee() {
  return (
    <div
      className="marquee"
      role="region"
      aria-label="Vestibulares e universidades mapeados no site. A faixa não indica que há questões de cada um."
    >
